...
/*
**  LOCK STYLE DESIGNED by liuchuang on 26/7/2019.
**         *******              *******
**        *         *           *         *
**        *         *           *         *
**        *                               *
...
namespace ui_common
{
class UI_COMMONSHARED_EXPORT Lock : public QObject, public CustomButtonDesignBase
{
    Q_OBJECT
public:
    Lock()
    ...
    Lock(const QString& _desrction, const QString& _helpDesrction, bool _bIsLockedStatus = true,
...
public:
    ...
    void setLockedStatus(bool _bLocked);
...
private:
    TextureMap *textureMapLocked, *textureMapUnLock;
    bool bCursorStayOnThisButton = false;
