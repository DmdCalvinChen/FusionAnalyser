...
/*
**  ARROW STYLE DESIGNED by liuchuang on 26/7/2019.
**             *
**        *         *
**
*/
...
namespace ui_common
{
class UI_COMMONSHARED_EXPORT Arrow : public QObject, public CustomButtonDesignBase
{
    Q_OBJECT
public:
    Arrow()
    ...
    Arrow(const QString& _desrction, const QString& _helpDesrction, bool _bIsUpperDirection = true,
