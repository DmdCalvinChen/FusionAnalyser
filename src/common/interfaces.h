...
public:
	...
	MeshCommonInterface() {
//#ifdef Q_OS_WIN
//log = LogSingleton::getInstance()->log;
//#endif
	}
...
public:
    ...
    virtual void Init(const QString&, MeshDocument &, MLSceneGLSharedDataContext::PerMeshRenderingDataMap& /*mp*/, GLArea *) {}
	virtual void Render(QAction *, MeshDocument &, MLSceneGLSharedDataContext::PerMeshRenderingDataMap& mp, GLArea *) = 0;
    virtual void Render(const QString&, MeshDocument &, MLSceneGLSharedDataContext::PerMeshRenderingDataMap& mp, GLArea *) {};
...
public:
	...
	*/
	...
	virtual bool startPostDecorate(QAction*, MeshDocument&, RichParameterSet*, GLArea*) { return false; }
	virtual void decorateMesh(QAction*, MeshModel&, RichParameterSet*, GLArea*, QPainter*, GLLogStream&) = 0;
	virtual void decoratePostDoc(QAction*, MeshDocument&, RichParameterSet*, GLArea*, QPainter*, GLLogStream&) {}
	// 如果存在action返回true否则false
	virtual bool decorateDoc(QAction*, MeshDocument&, RichParameterSet*, GLArea*, QPainter*, GLLogStream&) = 0;
	...
	virtual void endPostDecorate(QAction*, MeshDocument&, RichParameterSet*, GLArea*) {}
	...
	//virtual void drawAfterDocDecorate() {}
...
//#ifdef Q_OS_WIN
//        log->info("Enter StartEdit");
//        log->flush();
//#endif
		StartEdit(md, parent, cont);
	}

	virtual void DecorateBeforeMeshRender(MeshModel &m, GLArea *parent, QPainter * /*p*/)
	{
		DecorateBeforeMeshRender(m, parent);
	}
	virtual void DecorateBeforeMeshRender(MeshModel &m, GLArea *parent) {}

	virtual void DecorateGeometory2D(MeshModel &m, GLArea *parent, QPainter * /*p*/)
	{
		DecorateGeometory2D(m, parent);
	}
	virtual void DecorateGeometory2D(MeshModel &m, GLArea *parent) {}
	...
	virtual void mouseDoubleClickEvent(QMouseEvent *event, MeshModel &, GLArea *) = 0;
	...
	virtual void updateUI(bool isVisible = true) {};
};
...
public:
    ...
    virtual int order() { return -1; }        // 控制插件在工具栏的加载顺序

    virtual int type() { return -1; }         // 控制插件的类型（所属的模块：分牙、排牙、排产)
