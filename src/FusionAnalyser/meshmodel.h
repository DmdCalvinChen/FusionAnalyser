...
public:
    ...
    MeshModel *addNewMesh(QString fullPath, QString Label, bool setAsCurrent=true, ToothModelType upperOrLowerToothModelMark = UpperToothModel);
