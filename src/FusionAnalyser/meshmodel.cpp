	...
	ToothModelType upperOrLowerToothModelMark)
{
    ...
    MeshModel *newMesh = new MeshModel(this,qPrintable(fullPath),newlabel, upperOrLowerToothModelMark);
...
void MeshModel::GetDental(Dental &dental)
{
	this->cDental.loadDental(&this->cm, &this->cm, this->cDental.teeth);
	bGotDental = true;
}
